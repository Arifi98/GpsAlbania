<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin.aspx.cs" Inherits="GpsTirana.admin" %>
...
<head>
    ...
    <script>
        function admin() {
            ...
            Toast.fire({
                icon: 'success',
                title: 'Signed in successfully Admin'
            })
        }
        ...
        function operator() {
            ...
            Toast.fire({
                icon: 'success',
                title: 'Signed in successfully Operator'
            })
        }
        function a() {
            const Toast = Swal.mixin({
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <asp:label ID="loginUsername" text="user name" runat="server"  ForeColor="White"/>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                            ...
                            <div class="user-profile d-flex no-block dropdown m-t-20">
                                ...
                                <div class="user-content hide-menu m-l-10">
                                    <a href="javascript:void(0)" class="" id="Userdd" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <h5 class="m-b-0 user-name font-medium">Llogaria Juaj<i class="fa fa-angle-down"></i></h5>
                                        <asp:label ID="email" text="emaili@ktu.com" runat="server" CssClass="op-5 user-email" />
                                    </a>
                        ...
                        <li class="p-15 m-t-10"><a href="Rregjistro.aspx" class="btn btn-block create-btn text-white no-block d-flex align-items-center"><i class="fa fa-plus-square"></i> <span class="hide-menu m-l-5">New  installation</span> </a></li>

                        <!-- User Profile-->
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="shtoKlient.aspx" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu">Add new client</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="EditKlient.aspx" aria-expanded="false"><i class="mdi mdi-account-network"></i><span class="hide-menu">Edit Klient</span></a></li>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-7">
                        <div class="text-right upgrade-btn">
                            <a href="admin.aspx" class="btn btn-danger text-white" >Go to Admin page</a>
                        </div>
                    </div>
                </div>
            </div>
